class CityWall extends THREE.Group {
    ...
    if (this.type =="wallNS"){
        var texture = new THREE.TextureLoader().load( assetBaseUrl +"textures/wall/"+this.tex+".jpg" );    
        texture.wrapS = texture.wrapT = THREE.RepeatWrapping; 
        texture.repeat.set( this.bWidth / 60, 1 );  
        var rooftexture = new THREE.TextureLoader().load(assetBaseUrl + "textures/wall/concrete.jpg" );    
        rooftexture.wrapS = rooftexture.wrapT = THREE.RepeatWrapping; 
        rooftexture.repeat.set( this.bWidth / 60, 1 );  
        //material
        var hallMaterials = [
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/wall/"+this.tex+".jpg"), side: THREE.FrontSide }), //LEFT
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/wall/"+this.tex+".jpg"), side: THREE.FrontSide }), //RIGHT
            new THREE.MeshPhongMaterial({ map: rooftexture, side: THREE.FrontSide }), //TOP
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/ground/ground_mud.jpg"), side: THREE.FrontSide }), //BOTTOM
    ...
    //south west direction
        ...
        var hallMaterials = [
            ...
            new THREE.MeshPhongMaterial({ map: rooftexture, side: THREE.FrontSide }), //TOP
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/ground/ground_mud.jpg"), side: THREE.FrontSide }), //BOTTOM
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/wall/"+this.tex+".jpg"), side: THREE.FrontSide }), //FRONT
            new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load(assetBaseUrl +"textures/wall/"+this.tex+".jpg"), side: THREE.FrontSide }), //BACK
            ];
    }
    ...
    constructor(type,bHeight,bWidth,bDepth,crow,ccol,tex){
    super();
    this.type = type;

			...
			<div class="parentmini">
				...
				@foreach($quarters as $quarter)
					...
					@if($quarter->categories->quarter_name =="marke")
						...
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(255,255,255)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="hospital")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(106,0,255)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="gateway")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(160,82,45)" />
						</a>
						</g>
					...
					@elseif($quarter->categories->quarter_name =="market")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(255,255,136)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="diocese")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(225,213,231)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="port")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(27,161,226)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="centre")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(255,242,204)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="university")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(0,80,239)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="tiltyard")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(248,206,204)" />
						</a>
						</g>
					...
					@elseif($quarter->categories->quarter_name =="roadside_inn")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(240,163,10)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="fortified_abbey")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(218,232,252)" />
						</a>
						</g>
					...
					@elseif($quarter->categories->quarter_name =="commandery")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(216,0,115)" />
						</a>
						</g>
					...
					@elseif($quarter->categories->quarter_name =="farmstead")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(213,232,212)" />
						</a>
						</g>
					@elseif($quarter->categories->quarter_name =="hunting lodge")
						<g z-index="8">
						<a xlink:href="/quarters/{{ $quarter->quarter_id }}"><title>{{ $quarter->quarter_name }}</title>
						<rect width="70" height="70" x="{{ ($quarter->x * 70) - 70 }}" y="{{ ($quarter->y * 70) - 70 }}" stroke="rgb(0,0,0)" stroke-width="2" fill="rgb(96,169,23)" />
						</a>
						</g>
					@endif					
				@endforeach

...
@endif	
	...
	@if($placedata->fortification =="mountain_castle")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/building_castle.png') }}" width="48" height="48" alt="fortification" title="castle"></td>
	@elseif($placedata->fortification =="water_castle")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/building_castle.png') }}" width="48" height="48" alt="fortification" title="castle"></td>
	@elseif($placedata->fortification =="bishop_palace")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_incense_burner.png') }}" width="48" height="48" alt="fortification" title="city"></td>
	@elseif($placedata->fortification =="abbey_grange")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_leadlight_window.png') }}" width="48" height="48" alt="fortification" title="abbey"></td>
	@elseif($placedata->fortification =="fortified_abbey")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_leadlight_window.png') }}" width="48" height="48" alt="fortification" title="abbey"></td>
	@elseif($placedata->fortification =="abbey_scriptorium")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_book.png') }}" width="48" height="48" alt="fortification" title="abbey"></td>			
	@elseif($placedata->fortification =="royal_court")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_throne.png') }}" width="48" height="48" alt="fortification" title="royal court"></td>
	@elseif($placedata->fortification =="chancery")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/misc_throne.png') }}" width="48" height="48" alt="fortification" title="chancery"></td>
	@elseif($placedata->fortification =="burgh")
		<td class="pl" colspan="3"><img src="{{ asset('img/images/shield_2.png') }}" width="48" height="48" alt="fortification" title="burgh"></td>
	...
	@if($placedata->education =="hospice")
		<td class="pl" colspan="3"><img src="{{ asset('img/tradegoods/book_rare.png') }}" width="48" height="48" alt="education" title="hospice"></td>			
	@elseif($placedata->education =="library")
		<td class="pl" colspan="3"><img src="{{ asset('img/tradegoods/paper.png') }}" width="48" height="48" alt="education" title="libary"></td>
	@elseif($placedata->education =="university")
		<td class="pl" colspan="3"><img src="{{ asset('img/tradegoods/book_block.png') }}" width="48" height="48" alt="education" title="university"></td>	

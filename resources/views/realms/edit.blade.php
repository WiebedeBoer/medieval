...
<div class="container-fluid justify-content-center">
    ...
    <p>Chancellor</p>
        <div class="input-group">
		    <select name="chancellor" id="chancellor">
			@foreach($citizens as $citizen) 
				<option value="{{ $citizen->person_id }}" {{ $citizen->citizen ==$realm->rulers['chancellor'] ? 'selected' : '' }}>{{ $citizen->citizens->person_name }}, agriculture: {{ $citizen->citizens->agr }}, commerce: {{ $citizen->citizens->com }}, charisma: {{ $citizen->citizens->cha }}, engineer: {{ $citizen->citizens->eng }}, judgement: {{ $citizen->citizens->jud }}, leadership: {{ $citizen->citizens->lea }}</option>
   			@endforeach
            </select>
		</div>		
        <p>Chamberlain</p>
        <div class="input-group">
		    <select name="chamberlain" id="chamberlain">
			@foreach($citizens as $citizen) 
				<option value="{{ $citizen->person_id }}" {{ $citizen->citizen ==$realm->rulers['chamberlain'] ? 'selected' : '' }}>{{ $citizen->citizens->person_name }}, agriculture: {{ $citizen->citizens->agr }}, commerce: {{ $citizen->citizens->com }}, charisma: {{ $citizen->citizens->cha }}, engineer: {{ $citizen->citizens->eng }}, judgement: {{ $citizen->citizens->jud }}, leadership: {{ $citizen->citizens->lea }}</option>
   			@endforeach
            </select>
		</div>	
        <p>Marshall</p>
        <div class="input-group">
		    <select name="marshall" id="marshall">
			@foreach($citizens as $citizen) 
				<option value="{{ $citizen->person_id }}" {{ $citizen->citizen ==$realm->rulers['marshall'] ? 'selected' : '' }}>{{ $citizen->citizens->person_name }}, agriculture: {{ $citizen->citizens->agr }}, commerce: {{ $citizen->citizens->com }}, charisma: {{ $citizen->citizens->cha }}, engineer: {{ $citizen->citizens->eng }}, judgement: {{ $citizen->citizens->jud }}, leadership: {{ $citizen->citizens->lea }}</option>
   			@endforeach
            </select>
		</div>	
        <p>Admiral</p>
        <div class="input-group">
		    <select name="admiral" id="admiral">
			@foreach($citizens as $citizen) 
				<option value="{{ $citizen->person_id }}" {{ $citizen->citizen ==$realm->rulers['admiral'] ? 'selected' : '' }}>{{ $citizen->citizens->person_name }}, agriculture: {{ $citizen->citizens->agr }}, commerce: {{ $citizen->citizens->com }}, charisma: {{ $citizen->citizens->cha }}, engineer: {{ $citizen->citizens->eng }}, judgement: {{ $citizen->citizens->jud }}, leadership: {{ $citizen->citizens->lea }}</option>
   			@endforeach
            </select>
		</div>	
        <p>Steward</p>
        <div class="input-group">
			...
			@foreach($citizens as $citizen) 
				<option value="{{ $citizen->person_id }}" {{ $citizen->citizen ==$realm->rulers['steward'] ? 'selected' : '' }}>{{ $citizen->citizens->person_name }}, agriculture: {{ $citizen->citizens->agr }}, commerce: {{ $citizen->citizens->com }}, charisma: {{ $citizen->citizens->cha }}, engineer: {{ $citizen->citizens->eng }}, judgement: {{ $citizen->citizens->jud }}, leadership: {{ $citizen->citizens->lea }}</option>
   			@endforeach
            </select>
		</div>	
...
<div class="container-fluid justify-content-center">
    ...
    <div class="m-1"><a href="/guilds/{{$guild->guild_id}}">{{$guild->guild_name}}</a> in <a href="/place/{{$guild->places->place_id}}">{{$guild->places->place_name}}</a></div>
    @endforeach
    </div>
</div>
@endif   

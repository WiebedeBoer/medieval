...
<h2>Top 50 Places by Population</h2>
...
@foreach($placedata as $place)
    ...
    <g z-index="4"><text x="150" y="{{ $place->place_y + 25}}" fill="rgb(32,32,32)">{{ $place->population }}</text></g>
    <g z-index="3"><rect width="{{50 + $place->place_w}}" height="40" x="210" y="{{$place->place_y}}" style="fill:rgb(160,160,160);stroke-width:3;stroke:rgb(0,0,0)" /></g>  
    </a>
    @else
    <a xlink:href="/place/{{ $place->place_id }}"><title>{{ $place->place_name }}</title>
    ...
    <g z-index="4"><text x="150" y="{{ $place->place_y + 25}}" fill="black">{{ $place->population }}</text></g>
    <g z-index="3"><rect width="{{50 + $place->place_w}}" height="40" x="210" y="{{$place->place_y}}" style="fill:rgb(128,128,128);stroke-width:3;stroke:rgb(0,0,0)" /></g>  
    </a>
    @endif
@endforeach
</svg> 

...
<h2>Top 50 Places by Commerce</h2>
...
@foreach($placedata as $place)
    ...
    <g z-index="4"><text x="160" y="{{ $place->place_y + 25}}" fill="rgb(32,32,32)">{{ $place->com }}</text></g>
    ...
    <g z-index="4"><text x="160" y="{{ $place->place_y + 25}}" fill="black">{{ $place->com }}</text></g>

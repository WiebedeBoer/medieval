...
<div class="links">
		...
		<a href="/map/pigs" class="wmlink"><img src="{{ asset('img/tradegoods/pigs.png') }}" width="48" height="48" alt="button" title="button"> Worldmap (Pigs)</a>

		<a href="/map/poultry" class="wmlink"><img src="{{ asset('img/tradegoods/chicken.png') }}" width="48" height="48" alt="button" title="button"> Worldmap (Poultry)</a>
		...
		<a href="/map/grain" class="wmlink"><img src="{{ asset('img/tradegoods/grains.png') }}" width="48" height="48" alt="button" title="button"> Worldmap (Grains)</a>
